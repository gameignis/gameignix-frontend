...
export default function ToolsAndTechnologies() {
  ...
  const techData = [
    { src: "/common/java.webp", alt: "Java", width: 108 },
    ...
    { src: "/common/jmeter.webp", alt: "JMeter", width: 132 },
    { src: "/common/postman.webp", alt: "Postman", width: 132 },
    { src: "/common/cypress.webp", alt: "Cypress", width: 132 },
    { src: "/common/photoshop.webp", alt: "Photoshop", width: 132 },
    { src: "/common/illustrator.webp", alt: "Illustrator", width: 132 },
    { src: "/common/figma.webp", alt: "Figma", width: 132 },
    { src: "/common/adobe-xd.webp", alt: "Adobe XD", width: 132 },
    { src: "/common/sketch.webp", alt: "Sketch", width: 132 },
  ];
    ...
    <section className="pt-[2rem] pb-[4rem]">
      <div className="max-w-[1336px] md:px-[30px] px-[15px] mx-auto">
        <div className="text-center md:w-[90%] mx-auto w-full">
          ...
          <p className="font-semibold tracking-[0px] md:tracking-[1px] mb-[0.8rem] lg:text-[24px] text-[20px] text-[#ff8600] italic">
