...
export default function CasinoGameTools() {
      ...
      <div className="max-w-[1336px] md:px-[30px] px-[15px] mx-auto">
        <div className="text-center cm-head2">
          <h2 className="cm-title font-bold uppercase">
             Technologies We Use for Casino Game Development
          </h2>
          <p className="lead text-gray-400">
            At GameIgnix, we utilize a robust and versatile tech stack to develop secure and high-performance casino games, tailored for web, 
