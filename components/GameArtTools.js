...
export default function GameArtTools() {
  ...
  const techData = [
    ...
    { src: "/common/substance-painter-designer.webp", alt: "Substance Painter & Designer", width: 345 },
    { src: "/common/marvelous-designer.webp", alt: "Marvelous Designer", width: 230 },
      ...
      <div className="max-w-[1336px] md:px-[30px] px-[15px] mx-auto">
        <div className="text-center md:w-[90%] mx-auto w-full">
          ...
          <p className="text-[15px] lg:text-[18px] leading-[24px] md:leading-[28px] text-[#e6e6e6] mb-[1rem] md:mb-[2rem]">
            We employ a carefully selected stack of industry-standard tools and technologies to deliver game art with top-tier visual quality, seamless 
            compatibility, and high-performance output.  
          </p>
        </div>
