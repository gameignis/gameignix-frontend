...
export default function BlockchainGameTools() {
      ...
      <div className="container">
        <div className="text-center cm-head2">
          <h2 className="cm-title font-bold uppercase">
             Tech Stack, Our Experts Use to Create Your Blockchain Game
          </h2>
          <p className="lead text-gray-400">
            Craft a truly innovative and secure blockchain game, and our experts employ a comprehensive and cutting-edge tech stack. This 
            ensures the robustness and interactivity necessary for the next generation of gaming.
          </p>
        </div>
        <div className="tech-progress-wrapper">
          <div className="flex flex-wrap tech-categlis justify-center border-b border-white/10">
          ...
          <div className="tech-card-row">
            <div className="scrollimgs">
              ...
              <div className="tech-card">
                <Image src="/common/substance-painter-designer.webp" alt="Substance Painter & Designer" width={108} height={40} className="max-w-full h-auto flex-shrink-0" />
              </div>
              <div className="tech-card">
                <Image src="/common/marvelous-designer.webp" alt="Marvelous Designer" width={108} height={40} className="max-w-full h-auto flex-shrink-0" />
              </div>
              <div className="tech-card">
                <Image src="/common/c-sharp.webp" alt="C#" width={169} height={40} className="max-w-full h-auto flex-shrink-0" />
              </div>
              <div className="tech-card">
