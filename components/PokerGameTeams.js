           ...
           <div className="flex">
             <div className="w-full">
              ...
              <div className="my-[1rem] pr-6">
                <Image src="/common/poker-game/poker-game-app-development.webp" alt="Game Development Services Provider" width={640} height={350} loading="lazy" className="max-w-full h-auto flex-shrink-0" />
               </div>
              </div>
           </div>
           <div className="flex">
