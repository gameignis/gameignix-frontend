...
export default function BlockchainCaseStudies() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrent((prev) => (prev + 1) % BlockchainCaseStudiesdata.length);
    }, 5000);
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="flex flex-wrap w-full items-center gap-2 mb-[3px] lg:mb-[5px] [&_span]:text-[15px] [&_span]:lg:text-[16px] [&_span]:leading-[24px]">
                        <span className="icon">
                          <Image src="/common/genre-icon.webp" alt="Genre" width={28} height={28} loading="lazy" className="max-w-full h-auto flex-shrink-0" />
                        </span>
                      ...
                      <div className="flex flex-wrap w-full items-center gap-2 mb-[3px] lg:mb-[5px] [&_span]:text-[15px] [&_span]:lg:text-[16px] [&_span]:leading-[24px]">
                        <span className="icon">
                          <Image src="/common/platform-icon.webp" alt="Platform" width={28} height={28} loading="lazy" className="max-w-full h-auto flex-shrink-0" />
                        </span>
                      ...
                      <div className="flex flex-wrap w-full items-center gap-2 mb-[3px] lg:mb-[5px] [&_span]:text-[15px] [&_span]:lg:text-[16px] [&_span]:leading-[24px]">
                        <span className="icon">
                          <Image src="/common/engine-icon.webp" alt="Blockchain" width={28} height={28} loading="lazy" className="max-w-full h-auto flex-shrink-0" />
                        </span>
                        <span className="text-[#ff8600]">Blockchain:</span>
