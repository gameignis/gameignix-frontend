...
export default function MobileGameTools() {
      ...
      <div className="max-w-[1336px] md:px-[30px] px-[15px] mx-auto">
        <div className="text-center cm-head2">
          <h2 className="cm-title font-bold uppercase">
             Mobile Game Development Tools and Technologies We Use
          </h2>
          <p className="lead text-gray-400">
            Our team is equipped with a robust tech stack that includes advanced game engines, programming languages, frameworks, and design 
            tools, empowering us to create highly innovative mobile games and ensuring every project benefits from the latest advancements.
          </p>
        </div>
