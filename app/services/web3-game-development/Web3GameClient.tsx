  ...
  return (
    ...
    experiences.
      ...
      sustainable game economies.
          ...
          <section className="pt-[5rem] md:pt-[3rem] pb-[7rem]">
    ...
    functioning. 
              ...
              <div className="relative flex flex-wrap">
                <div className="absolute left-0 top-0 z-[1] w-full lg:w-auto flex-none h-full lg:h-auto opacity-20 md:opacity-100">
                  <div className="relative -top-[120px] -ml-[15px] h-full lg:h-auto">
                    <Image src="/common/web3-game/web3-game-company.webp" alt="Web3 Game Company" width={800} height={950} className="block object-cover w-full h-full md:h-auto md:max-w-full" />
                  </div>
                </div>
                <div className="md:w-2/3 md:ml-auto px-2 z-[2]">
                  <div className="lg:pr-5 md:pr-3 pr-0 relative">
                    <div className="bg-[#ffffff0d] border border-[#fff3] rounded-[14px] md:w-[90%] w-[94%] my-[1rem] lg:my-[3rem] px-[20px] py-[2px]">
                      <h3 className="text-[18px] leading-[26px] md:text-[20px] md:leading-[28px] text-left my-[10px] md:my-[1rem] text-[#ff8600] font-semibold italic">Ideation</h3>
      ...
      strategies. This phase ensures your Web3 game is user-engaging, market-ready, and profitable.
                    ...
                    <div className="bg-[#ffffff0d] border border-[#fff3] rounded-[14px] md:w-[90%] w-[94%] my-[1rem] lg:my-[3rem] px-[20px] py-[2px] ml-[1.3rem] md:ml-[5rem]">
                      <h3 className="text-[18px] leading-[26px] md:text-[20px] md:leading-[28px] text-left my-[10px] md:my-[1rem] text-[#ff8600] font-semibold italic">Blockchain Architecture</h3>
                      <p className="text-[14px] leading-[20px] lg:text-[16px] lg:leading-[24px] mb-[1rem]">
      ...
      and compliance factors to design a secure, high-performance framework tailored to the game’s requirements.
                    ...
                    <div className="bg-[#ffffff0d] border border-[#fff3] rounded-[14px] md:w-[90%] w-[94%] my-[1rem] lg:my-[3rem] px-[20px] py-[2px]">
                      <h3 className="text-[18px] leading-[26px] md:text-[20px] md:leading-[28px] text-left my-[10px] md:my-[1rem] text-[#ff8600] font-semibold italic">Smart Contract Development</h3>
                      <p className="text-[14px] leading-[20px] lg:text-[16px] lg:leading-[24px] mb-[1rem]">
      ...
      gas-optimized, and audit-ready code to prevent exploits and downtime. 
                    ...
                    <div className="bg-[#ffffff0d] border border-[#fff3] rounded-[14px] md:w-[90%] w-[94%] my-[1rem] lg:my-[3rem] px-[20px] py-[2px] ml-[1.3rem] md:ml-[5rem]">
                      <h3 className="text-[18px] leading-[26px] md:text-[20px] md:leading-[28px] text-left my-[10px] md:my-[1rem] text-[#ff8600] font-semibold italic">UI/UX Development</h3>
                      <p className="text-[14px] leading-[20px] lg:text-[16px] lg:leading-[24px] mb-[1rem]">
      ...
      that make it easy for crypto and mainstream users to smoothly onboard. 
                    ...
                    <div className="bg-[#ffffff0d] border border-[#fff3] rounded-[14px] md:w-[90%] w-[94%] my-[1rem] lg:my-[3rem] px-[20px] py-[2px]">
                      <h3 className="text-[18px] leading-[26px] md:text-[20px] md:leading-[28px] text-left my-[10px] md:my-[1rem] text-[#ff8600] font-semibold italic">Testing and Optimization</h3>
                      <p className="text-[14px] leading-[20px] lg:text-[16px] lg:leading-[24px] mb-[1rem]">
      ...
      and transaction fee optimization, every game element is tested for stability.
                    ...
                    <div className="bg-[#ffffff0d] border border-[#fff3] rounded-[14px] md:w-[90%] w-[94%] my-[1rem] lg:my-[3rem] px-[20px] py-[2px] ml-[1.3rem] md:ml-[5rem]">
                      <h3 className="text-[18px] leading-[26px] md:text-[20px] md:leading-[28px] text-left my-[10px] md:my-[1rem] text-[#ff8600] font-semibold italic">Deployment and Post-Launch Support</h3>
                      <p className="text-[14px] leading-[20px] lg:text-[16px] lg:leading-[24px] mb-[1rem]">
      ...
      expansions, and patches, we will ensure that your game and your players stay entertained.
                ...
                <div className="order-1 md:order-2 absolute w-full right-[-12px] top-0 z-[1] flex justify-end lg:w-auto lg:h-auto h-full opacity-20 md:opacity-100">
                  <div className="w-full h-full lg:w-auto lg:h-auto">
                    <Image src="/common/unity-game/unity-game-development-studio.webp" alt="Unity Game Development Studio" width={490} height={800} className="block object-cover w-full h-full md:h-auto md:max-w-full" />
                  </div>
                </div>
              </div>
            </div>
