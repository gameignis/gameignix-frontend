    ...
    <>
      ...
      <main>
        ...
        <section className="relative h-[580px] md:h-[700px] text-white after:content-[''] after:absolute after:inset-0 after:bg-black/40 after:z-[2] before:content-[''] before:absolute before:left-0 before:bottom-0 before:w-full before:h-[30%] before:z-[2] before:bg-gradient-to-t before:from-black before:from-50% before:to-transparent"> 
          ...
          <Image src="/common/unreal-game/unreal-engine-game-development-company.webp" alt="Unreal Engine Game Development Company" fill priority className="hidden md:block h-full w-full object-cover" />
      ...
      high-performance games that push the bar of visual fidelity and gameplay, setting new standards in the industry.
          ...
          compatibility.
                      ...
                      <div className="md:w-[42%] flex absolute right-0 bottom-0 opacity-20 md:opacity-100 h-full md:h-auto">
                        <div className="flex flex-col w-full h-full flex flex-column">
                          <Image src="/common/unreal-game/unreal-engine-game-development-services.webp" alt="Unreal Engine Game Development Services" width={600} height={600} className="w-full h-full md:h-[560px] object-contain" />
                        </div>
                      </div>
                  </div>
                </div>
                ...
                <div className="p-px rounded-[18px] bg-[linear-gradient(224deg,#FC74005E_0%,#964500d4_100%)]">
                  <div className="flex rounded-[18px] p-[15px] md:p-[20px] bg-[linear-gradient(-253.75deg,#010101_68.95%,#3E0803_123.66%,#7A0F04_213.15%)] relative">
                    <div className="md:w-[42%] flex absolute left-0 bottom-0 opacity-20 md:opacity-100 h-full md:h-auto">
                        <div className="flex flex-col w-full h-full flex flex-column">
                          <Image src="/common/unreal-game/unreal-engine-game-development-studio.webp" alt="Unreal Engine Game Development Studio" width={600} height={600} className="w-full h-full md:h-[560px] object-contain" />
                        </div>
                       </div>
          ...
          <section className="relative flex items-end overflow-hidden text-center text-white py-[25px] md:py-[55px] pb-[10px] mt-12 mb-4">
            <Image src="/common/unreal-game/game-idea.webp" alt="Your Idea, Our Next Big Game!" width={1440} height={600} className="absolute inset-0 w-full h-full object-cover" />
              ...
              <div className="relative flex flex-wrap">
                <div className="absolute left-0 top-0 z-[1] w-full lg:w-auto flex-none h-full lg:h-auto opacity-20 md:opacity-100">
                  <div className="relative -top-[120px] -ml-[15px] h-full lg:h-auto">
                    <Image src="/common/unreal-game/unreal-engine-game-developers.webp" alt="Unreal Engine Game Developers" width={700} height={1000} className="block object-cover w-full h-full md:h-auto md:max-w-full" />
                  </div>
                </div>
      ...
      patches to keep players engaged and maintain the game’s longevity in the market.
                ...
                <div className="order-1 md:order-2 absolute w-full right-[-12px] top-0 z-[1] flex justify-end lg:w-auto lg:h-auto h-full opacity-20 md:opacity-100">
                  <div className="w-full h-full lg:w-auto lg:h-auto">
                    <Image src="/common/unreal-game/unreal-engine-game-development-agency.webp" alt="Unreal Engine Game Development Agency" width={490} height={800} className="block object-cover w-full h-full md:h-auto md:max-w-full" />
                  </div>
                </div>
              </div>
            </div>
