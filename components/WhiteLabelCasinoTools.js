...
export default function WhiteLabelCasinoTools() {
  ...
  const techData = [
    ...
    { src: "/common/Zbrush.webp", alt: "Zbrush", width: 163 },
    { src: "/common/substance-painter-designer.webp", alt: "Substance Painter Designer", width: 150 },
    { src: "/common/marvelous-designer.webp", alt: "Marvelous Designer", width: 132 },
      ...
      <div className="max-w-[1336px] md:px-[30px] px-[15px] mx-auto">
        <div className="text-center md:w-[90%] mx-auto w-full">
          ...
          <p className="text-[15px] lg:text-[18px] leading-[24px] md:leading-[28px] text-[#e6e6e6] mb-[1rem] md:mb-[2rem]">
            We use advanced tools and technologies to develop secure, high-performance casino platforms. From powerful game engines to 
            encrypted payment systems, everything is built for reliability and scalability.
          </p>
        </div>
